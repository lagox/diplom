# RailsAdmin config file. Generated on April 20, 2012 16:04
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Diplom', 'Admin']
  ...
  # config.excluded_models = [Category, Comment, Job, Rate, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Category, Comment, Job, Rate, User]
  ...
  #   # Found associations:
  #     configure :jobs, :has_many_association   #   # Found columns:
  ...
  #     configure :all_rates, :has_many_association 
  #     configure :all_raters, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :title, :string 
  ...
  #     configure :user_id, :integer         # Hidden 
  #     configure :rating_average, :decimal   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #     configure :comments, :has_many_association 
  #     configure :ratings_given, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  ...
  #     configure :typeuser, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
